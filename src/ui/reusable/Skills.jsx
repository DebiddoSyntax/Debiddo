...
const Skills = () => {
    ...
    return (
        <div className='text-center bg-[#04010A] px-5 md:px-10 lg:px-20 pt-14 pb-24 md:pt-20 md:pb-36 '>
            <h2 className={`p-3 font-semibold text-2xl md:text-4xl delay-800ms duration-1000 ease-in-out ${SkillsRefisVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={SkillsRef}>My Skills</h2>
            <div className={`text-center delay-800ms duration-1000 ease-in-out ${SkillsRefisVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={SkillsRef}><p className='p-3 font-normal text-sm md:text-lg'>Skilled in UX/UI Design, HTML, CSS, JavaScript, React.js, and React Native. I create engaging, responsive interfaces for web and mobile platforms.</p></div>
                <div className='grid grid-cols-3 md:grid-cols-3 lg:grid-cols-6 w-full gap-6 px-0 mt-10 md:mt-14'>
                    
                    <div className={`flex flex-col py-5 px-10 md:py-10 md:px-16 my-auto border-4 border-primary items-center text-center delay-800ms duration-1000 ease-in-out ${SkillsRefisVisible ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={SkillsRef}>
