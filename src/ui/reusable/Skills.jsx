    ...
    return (
        <div className='text-center bg-navbar-background px-5 md:px-10 lg:px-20 pt-10 pb-20 md:pt-20 md:pb-36 '>
            ...
            <div className={`text-center delay-800ms duration-1000 ease-in-out 
                ...
                ref={SkillsRef}
            >
                <p className='mt-3 px-3 font-normal text-sm md:text-base'>
                    Skilled in product design and frontend development. I create engaging, responsive interfaces for web and mobile platforms.
                </p>
            </div>

            <div className="flex flex-wrap justify-center gap-10 mt-10 md:mt-14">
                <div class="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512" class="text-4xl mb-2 text-pink-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 512 512" class="text-4xl mb-2 text-sky-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" class="text-4xl mb-2 text-gray-900 dark:text-white" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div className="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 448 512" class="text-4xl mb-2 text-yellow-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 384 512" class="text-4xl mb-2 text-blue-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" role="img" viewBox="0 0 24 24" class="text-4xl mb-2 text-sky-400" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
                ...
                <div class="flex flex-col items-center justify-center bg-icon-bg border border-icon-bg rounded-xl p-5 w-28 h-28   transition">
                    <svg stroke="currentColor" fill="currentColor" stroke-width="0" viewBox="0 0 576 512" class="text-4xl mb-2 text-purple-500" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg">
