  ...
  return (
    <div className='pt-10 md:pt-20 pb-52 lg:pb-80 px-5 md:px-10 lg:px-20'>
        ...
        <div className={`mt-16 md:mt-24 mb-10 md:mb-14 duration-1000 delay-75 ease-in-out ${DevRefisVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-20'}`} ref={DevRef}>
            ...
            <div className={`delay-800ms duration-1000 ease-in-out bg-[#d9d9d9] mt-10 md:mt-20 lg:mt-28 px-3 py-5 md:px-8 rounded-sm md:rounded-xl cursor-pointer h-auto ${AftrieruroRefisVisible && AftrieruroLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={AftrieruroRef}>
                <Link to={'/aftrieuro'}>
                    <img src={aftrieuro} alt="UntamedE" className='mt-0 md:mt-5 w-full h-full object-cover ' onLoad={()=> setAftrieruroLoaded(true)}/>
                </Link>
                <div className='flex justify-between items-center mt-4 md:mt-5'><p className='text-[#1f1b1b] text-base md:text-lg lg:text-2xl font-semibold'>Aftrieuro Dynamics LTD</p><button className='flex text-xs md:text-sm xl:text-base items-center px-5 py-3 md:px-8 lg:px-10 md:py-4 lg:py-5 bg-primary hover:bg-[#46256A] font-semibold' onClick={() => window.open('https://aftrieurodynamics.com/', '_blank')} >View Live Website <span className='mx-1 md:mx-3'><FiExternalLink /></span></button></div>
            </div>

        <div className={`delay-800ms duration-1000 ease-in-out bg-[#d9d9d9] mt-10 md:mt-20 lg:mt-28 px-3 py-5 md:px-8 rounded-sm md:rounded-xl cursor-pointer h-auto ${UntamedERefisVisible && UntamedELoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={UntamedERef} onClick={() => window.open('https://untamedcheck.netlify.app/', '_blank')}>
            <img src={Untamed} alt="UntamedE" className='mt-0 md:mt-5 w-full h-full object-cover ' onLoad={()=> setUntamedELoaded(true)}/>
            <div className='flex justify-between items-center mt-5'><p className='text-[#1f1b1b] text-base md:text-lg lg:text-2xl font-semibold'>Untamed Check</p><button className='flex text-xs md:text-sm xl:text-base items-center px-5 py-3 md:px-8 lg:px-10 md:py-4 lg:py-5 bg-primary hover:bg-[#46256A] font-semibold' >View Live Website <span className='mx-1 md:mx-3'><FiExternalLink /></span></button></div>
        </div>
        <div className={`delay-800ms duration-1000 ease-in-out bg-[#d9d9d9] mt-10 md:mt-20 lg:mt-28 px-3 py-5 md:px-8 rounded-sm md:rounded-xl cursor-pointer h-auto ${AnimedebRefisVisible && animedebLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={AnimedebRef} onClick={() => window.open('https://animedeb.netlify.app/', '_blank')}>
            <img src={Animedeb} alt="Animedeb" className='mt-0 md:mt-5 w-full h-full object-cover ' onLoad={()=> setAnimedebLoaded(true)}/>
            <div className='flex justify-between items-center mt-5'><p className='text-[#1f1b1b] text-base md:text-lg lg:text-2xl font-semibold'>Animedeb</p><button className='flex text-xs md:text-sm xl:text-base items-center px-5 py-3 md:px-8 lg:px-10 md:py-4 lg:py-5 bg-primary hover:bg-[#46256A] font-semibold' >View Live Website <span className='mx-1 md:mx-3'><FiExternalLink /></span></button></div>
        </div>
        ...
        <div className={`delay-800ms duration-1000 ease-in-out bg-[#d9d9d9] mt-10 md:mt-20 lg:mt-28 px-3 py-5 md:px-8 rounded-sm md:rounded-xl cursor-pointer h-auto ${CrowdHelpRefisVisible && crowdhelpLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={CrowdHelpRef} onClick={() => window.open('https://www.behance.net/gallery/211811185/CrowdHelp-Mobile-App', '_blank')}>
            <img src={crowdhelp} alt="crowdhelp" className='mt-0 md:mt-5 w-full h-full object-cover ' onLoad={()=> setCrowdhelpLoaded(true)}/>
            <div className='flex justify-between items-center mt-5'><p className='text-[#1f1b1b] text-base md:text-lg lg:text-2xl font-semibold'>CrowdHelp</p><button className='flex text-xs md:text-sm xl:text-base items-center px-5 py-3 md:px-8 lg:px-10 md:py-4 lg:py-5 bg-primary hover:bg-[#46256A] font-semibold'>View on Behance <span className='mx-1 md:mx-3'><FiExternalLink /></span></button></div>
        </div>

        <div className={`delay-800ms duration-1000 ease-in-out bg-[#d9d9d9] mt-10 md:mt-20 lg:mt-28 px-3 py-5 md:px-8 rounded-sm md:rounded-xl cursor-pointer h-auto ${CryptoFRefisVisible && cryptoFolioLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={CryptoFRef} onClick={() => window.open('https://www.behance.net/gallery/143681909/Web3-case-study-%28CryptoFolio-Web-app%29', '_blank')}>
            <img src={Cryptofolio} alt="cryptofolio" className='mt-0 md:mt-5 w-full h-full object-cover ' onLoad={()=> setCryptoFolioLoaded(true)}/>
            <div className='flex justify-between items-center mt-5'><p className='text-[#1f1b1b] text-base md:text-lg lg:text-2xl font-semibold'>CryptoFolio</p><button className='flex text-xs md:text-sm xl:text-base items-center px-5 py-3 md:px-8 lg:px-10 md:py-4 lg:py-5 bg-primary hover:bg-[#46256A] font-semibold'>View on Behance <span className='mx-1 md:mx-3'><FiExternalLink /></span></button></div>
        </div>

        <div className={`delay-800ms duration-1000 ease-in-out bg-[#d9d9d9] mt-10 md:mt-20 lg:mt-28 px-3 py-5 md:px-8 rounded-sm md:rounded-xl cursor-pointer h-auto ${HashtagsRefisVisible && hashtagsLoaded ? 'opacity-100 translate-x-0' : 'opacity-0 -translate-x-20'}`} ref={HashtagsRef} onClick={() => window.open('https://www.behance.net/gallery/138711137/Sneaker-store-mobile-app-UX-case-study', '_blank')}>
            <img src={HashtagSneaker} alt="hashtags" className='mt-0 md:mt-5 w-full h-full object-cover ' onLoad={()=> setHashtagsLoaded(true)}/>
            <div className='flex justify-between items-center mt-5'><p className='text-[#1f1b1b] text-base md:text-lg lg:text-2xl font-semibold'>Hashtags Sneaker</p><button className='flex text-xs md:text-sm xl:text-base items-center px-5 py-3 md:px-8 lg:px-10 md:py-4 lg:py-5 bg-primary hover:bg-[#46256A] font-semibold'>View on Behance <span className='mx-1 md:mx-3'><FiExternalLink /></span></button></div>
        </div>
