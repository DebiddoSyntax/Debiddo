  ...
  return (
    <div>
        ...
        <div className='mt-20 p-20 bg-[#AF93C6] h-full w-full'>
            <h4 className='text-2xl font-bold text-primary text-center'>HOBBIES</h4>
            <p className='text-center text-2xl font-semibold mt-3'>Things I love to do with my free time</p>

            <div className='mx-auto grid grid-cols-1 md:grid-cols-3 gap-10 mt-10 '>
                <div className='bg-primary px-10 pt-28 pb-8'>
