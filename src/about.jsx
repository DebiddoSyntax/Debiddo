  ...
  return (
    <div>
        <div className={`px-5 md:px-10 lg:px-20 pt-20 mb-20 delay-800ms duration-1000 ease-in-out ${DavidRefisVisible ? 'opacity-100 translate-y-0' : 'opacity-0 -translate-y-20'}`} ref={DavidRef}>
            ...
            <div className='mt-0'>
                <h1 className='text-sm md:text-xl font-medium w-full md:w-[70%] leading-7 md:leading-10 text-justify'>I am a frontend developer with a background in UI/UX design, passionate about bridging design and development to create intuitive and visually compelling digital experiences. My design roots give me a strong eye for detail and user-centered thinking, while my skills in HTML, CSS, JavaScript, and React allow me to bring concepts to life on the web. I thrive on building responsive, user-friendly interfaces that make technology feel effortless and accessible. As I continue to grow in development, I'm excited to blend creativity with code to deliver impactful solutions.</h1>
            </div>
        </div>
